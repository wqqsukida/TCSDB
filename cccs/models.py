...
class TestCycle(models.Model):
    ...
    CycleName = models.CharField('TestCycle名称', max_length=32, null=True, blank=True)
...
class TestPlan(models.Model):
    ...
    TestPlan表
    '''
    CaseName = models.CharField('TestCase名称', max_length=64, null=True, blank=True)
    CycleID = models.ForeignKey(verbose_name='TestCycle ID', to='TestCycle',on_delete=models.SET_NULL)
    Created = models.DateTimeField('创建日期',auto_now_add=True)
...
class TestRun(models.Model):
    ...
    TCID = models.ForeignKey(verbose_name='TestCycle ID', to='TestCycle',on_delete=models.SET_NULL)
...
class TestAction(models.Model):
    ...
    ActionType = models.CharField(choices=ActionChoice)
    ...
    PlanID = models.ForeignKey(to='TestPlan',on_delete=models.SET_NULL)
    CycleID = models.ForeignKey(to='TestCycle',on_delete=models.SET_NULL)
