...
class ResultSummary(models.Model):
    ...
    TotalCases = models.IntegerField('测试用例总数',blank=True,null=True)
    PassCnt = models.IntegerField('Pass用例总数',blank=True,null=True)
    FailCnt = models.IntegerField('Fail用例总数',blank=True,null=True)
    AbortCnt = models.IntegerField('Abort用例总数',blank=True,null=True)
    SkipCnt = models.IntegerField('Skip用例总数',blank=True,null=True)
    CPassCnt = models.IntegerField('Conditional Pass用例总数',blank=True,null=True)
    NotRunCnt = models.IntegerField('NotRun用例总数',blank=True,null=True)
...
class ResultDetail(models.Model):
    ...
    功能测试结果详情
    '''
    TRID = models.ForeignKey(verbose_name='TestResult ID',to='',on_delete=models.CASCADE)
...
class ResultFailure(models.Model):
    ...
    功能测试失败详情
    '''
    RRID = models.ForeignKey(verbose_name='ResultRecord ID', to='', on_delete=models.CASCADE)
